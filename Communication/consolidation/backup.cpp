...
//
//REEVALUATE START UNLOAD AND CREATE PART
//
//
...
//testing of all Siemens with new info of model fk
//FIGURE OUT WHAT's GOING ON WITH SECOND CALL OF READ
//*/
//
//
//#ifdef OS_WINDOWS
...
//	}
//}
//void readDB(string table) {		//no longer a super necessary function, but still nice to have
...
//}
//
//bool createPart(string Serial, string modelName) {	//add part to database, if something goes wrong, return false
//	bool out = true;
//	string model_fk;
...
//}
//
//string Read(int station, int start, int end, int tagIndex = 0) {		//reads for Serial string in either rockwall or siemens, thakes in offset if second string for siemens (start and end for siemens, tagIndex for rockwell)
//	if (Make == "ROCKWELL") {
